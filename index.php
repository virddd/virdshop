    ...
    <div>
        ...
        <div class="flex flex-wrap justify-evenly mb-4">
            <a href="pages/event.php?event=flash">    
                <div class="xl:scale-140 xl:my-4 lg:scale-130 lg:my-3 md:scale-120 md:my-2 sm:scale-110 sm:my-1 transition-all duration-300 ease-in-out hover:ring-2 hover:ring-orange-500  bg-[#f64301] w-17 h-17 rounded-full overflow-hidden m-2"><img src="assets/img/ui/sale.svg" alt=""></div>
            </a>  
            <a href="pages/event.php?event=voucher">
                <div class="xl:scale-140 xl:my-4 lg:scale-130 lg:my-3 md:scale-120 md:my-2 sm:scale-110 sm:my-1 transition-all duration-300 ease-in-out hover:ring-2 hover:ring-orange-500  bg-[#f64301] w-17 h-17 rounded-full overflow-hidden m-2"><img src="assets/img/ui/vocer.svg" alt=""></div>
            </a>  
            <a href="pages/event.php?event=best">
                <div class="xl:scale-140 xl:my-4 lg:scale-130 lg:my-3 md:scale-120 md:my-2 sm:scale-110 sm:my-1 transition-all duration-300 ease-in-out hover:ring-2 hover:ring-orange-500  bg-[#f64301] w-17 h-17 rounded-full overflow-hidden m-2"><img src="assets/img/ui/best.svg" alt=""></div>
            </a>  
            <a href="pages/event.php?event=cs">
                <div class="xl:scale-140 xl:my-4 lg:scale-130 lg:my-3 md:scale-120 md:my-2 sm:scale-110 sm:my-1 transition-all duration-300 ease-in-out hover:ring-2 hover:ring-orange-500  bg-[#f64301] w-17 h-17 rounded-full overflow-hidden m-2"><img src="assets/img/ui/service.svg" alt=""></div>
            </a>  
        </div>
    </div>
