...
<body class="bg-[#fff5e8] h-[80vh]">
    ...
    <div class="flex flex-col items-center h-[80vh] justify-center">
        <div class="bg-[#f64301] p-6 w-xs sm:w-sm md:w-md lg:w-md xl:w-md rounded-3xl flex flex-col items-center justify-center">
            ...
            <div>
                <h1 class="text-white text-center my-5 text-xl font-bold">Ayo login!</h1>
            </div>
            <form class="flex gap-y-8 flex-col items-center justify-center m-2" action="submit" method="post" id="signup">
                ...
                <input class="bg-[#fff5e8] px-4 py-2 rounded-2xl w-3xs sm:w-xs md:w-sm lg:w-sm xl:w-sm transition-all duration-300 ease-in-out" type="text" name="text" id="nama" placeholder="Nama">
                <input class="bg-[#fff5e8] px-4 py-2 rounded-2xl w-3xs sm:w-xs md:w-sm lg:w-sm xl:w-sm transition-all duration-300 ease-in-out" type="password" name="sandi" id="sandi" placeholder="Sandi">
                <button class="bg-[#fff5e8] py-2 px-14 rounded-2xl" type="submit">Masuk</button>
            </form>
        </div>
        <a class="mt-5 text-sm underline hover:text-orange-500" href="daftar.php">Belum punya akun? daftar disini!</a>
    </div>
