...
<body class="bg-[#fff5e8]">
    ...
    <div class="w-screen flex justify-center items-center">
        <div class="w-90 h-120 justify-center items-center mt-[10vh] bg-orange-600 flex flex-col rounded-xl">
            ...
            <table class="my-13 capitalize text-orange-950 rounded-lg overflow-hidden">
